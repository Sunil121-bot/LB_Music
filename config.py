...
OWNER_ID = int(getenv("OWNER_ID", "@no_one_care_0"))
...
SUPPORT_CHANNEL = getenv("SUPPORT_CHANNEL", "@Themedicohub77")
SUPPORT_CHAT = getenv("SUPPORT_CHAT", "@Themedicohub77")
...
START_IMG_URL = getenv(
    "START_IMG_URL", "https://envs.sh/jUI.jpg"
)
PING_IMG_URL = getenv(
    "PING_IMG_URL", "https://envs.sh/jUI.jpg"
)
PLAYLIST_IMG_URL = "https://envs.sh/jUI.jpg"
STATS_IMG_URL = "https://envs.sh/jUI.jpg"
